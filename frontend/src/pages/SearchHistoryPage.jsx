      ...
      <div className='max-w-6xl mx-auto px-8 py-4'>
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3'>
          {searchHistory?.map((entry,i)=>(
            <div key={entry.id+i} className='bg-gray-800 p-4 rounded flex items-start'>
              <img 
              ...
              <span className={`py-1 px-3 min-w-20 text-center rounded-full text-sm ml-auto ${entry.searchType === "movie" ? "bg-red-600" : (entry.searchType === "movie") ? "bg-blue-600" : "bg-green-600"}`}>
